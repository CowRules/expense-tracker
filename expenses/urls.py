...
urlpatterns = [
    ...
    re_path(
        r'^transactions/(?P<pk>\d+)$', transaction.TransactionSubtransactionsListView.as_view()
    ),
    re_path(r'^transactions/(?P<pk>\d+)/edit$', transaction.TransactionUpdateView.as_view()),
    re_path(r'^transactions/(?P<pk>\d+)/delete$', transaction.TransactionDeleteView.as_view()),
    re_path(r'^accounts$', account.AccountListView.as_view()),
    re_path(r'^accounts/(?P<pk>\d+)$', account.AccountSubtransactionsListView.as_view()),
    ...
    re_path(r'^sync/(?P<pk>\d+)$', account_sync.AccountSyncDetailView.as_view()),
    re_path(r'^sync/(?P<pk>\d+)/edit$', account_sync.AccountSyncUpdateView.as_view()),
    re_path(r'^sync/(?P<pk>\d+)/delete$', account_sync.AccountSyncDeleteView.as_view()),
    re_path(r'^accounts/(?P<account_pk>\d+)/sync$', account_sync.AccountSyncCreateView.as_view()),
